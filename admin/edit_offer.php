...
require '../db/db.php';
$id=$_GET['id'];
$search="SELECT * FROM offres WHERE id='$id'";
        ...
        <!-- Layout container -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Formulaires/</span> Modifier l'Offre</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Modifications de l'Offre</h5>
                      <small class="text-muted float-end">Veuillez completez tous les champs ! </small>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="actions/edit_offer.php" enctype="multipart/form-data">
                        
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Modifier le titre du Post</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Modifier le Deadline de l'Offre</label>
                          <div class="col-sm-10">
                            <input
                              type="datetime-local"
                              class="form-control"
