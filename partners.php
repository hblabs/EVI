...
require 'db/db.php';
$id=$_GET['id'];
$imgsearch="SELECT * FROM `partenaires` WHERE id='$id'";
                        ...
                        <div class="single-post">
                            <div class="feature-img">
                                <div class="galery">
                                    <div class="self-gallery">
                                        <a href="<?php echo $partimg ?>" data-lightbox="mygallery">
                                <img class="card-img rounded-0" src="<?php echo $partimg ?>" alt="" style="height: 500px; object-fit: contain;">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link mt-3 mb-4">
                                    <li><a href="#"><i class="fa fa-user"></i> <?php echo $nom ?></a></li>
